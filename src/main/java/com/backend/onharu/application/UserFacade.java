...
import com.backend.onharu.domain.user.dto.UserProfile;
...
import static com.backend.onharu.domain.user.dto.UserProfile.*;
...
public class UserFacade {
     ...
     * 사용자(가게) 프로필 조회
     *
     * @param query 사용자 ID, 등급 ID, 가게 ID 가 포함된 query
     * @return 조회된 사용자, 등급, 가게 엔티티
     */
    public UserOwnerProfile getOwnerProfile(GetOwnerProfileQuery query) {
        ...
        Level level = owner.getLevel(); // 가게에 연결된 등급 도메인 추출
